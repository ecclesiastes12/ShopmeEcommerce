...
//		return repo.findAll(pageable);
	...
	//method that save only product price
	//this method is for those with salespersons role
	public void saveProductPrice(Product productInForm) {
		//grab the product from the database by id
		Product productInDB = repo.findById(productInForm.getId()).get();
		
		//set or update new cost, price and discount if any
		productInDB.setCost(productInForm.getCost());
		productInDB.setPrice(productInForm.getPrice());
		productInDB.setDiscountPercent(productInForm.getDiscountPercent());
		
		//save the updated cost, price and discount of the product
